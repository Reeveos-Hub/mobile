            ...
            <div className="flex items-center justify-center" style={{ width: 28, height: 28 }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M3 9.5L12 3l9 6.5V20a1 1 0 01-1 1H4a1 1 0 01-1-1V9.5z"
                  fill={isActive("/app") ? "#111111" : "none"}
                  stroke={isActive("/app") ? "#111111" : "#BBBBBB"}
                  strokeWidth="1.8" strokeLinejoin="round" />
                {isActive("/app") && <rect x="9" y="14" width="6" height="7" rx="1" fill="#C9A84C" />}
              </svg>
            </div>
            <span style={{ fontSize: 10, fontWeight: isActive("/app") ? 700 : 500, color: isActive("/app") ? "#111111" : "#BBBBBB", letterSpacing: 0.2 }}>Home</span>
          </button>
