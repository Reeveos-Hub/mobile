...
export function SplashScreen() {
  ...
  return (
    <div style={{
      ...
      <motion.p initial={{opacity:0,y:10}} animate={{opacity:1,y:0}} transition={{delay:0.3,duration:0.5}} style={{marginTop:20,fontSize:28,fontWeight:800,color:"#FFFFFF",letterSpacing:0.5}}>ReeveOS</motion.p>
      <motion.p initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.7,duration:0.6}} style={{marginTop:8,fontSize:12,fontWeight:500,color:"rgba(255,255,255,0.3)",letterSpacing:0.5}}>Your business, in your pocket</motion.p>
