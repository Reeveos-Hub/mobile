...
const NOTIF_ICON: Record<string, { color: string; icon: React.ReactNode }> = {
  booking: { color: "#C9A84C", icon: <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><rect x="1.5" y="2.5" width="11" height="9" rx="1.5" stroke="#C9A84C" strokeWidth="1.3" /><path d="M1.5 6h11" stroke="#C9A84C" strokeWidth="1.3" /></svg> },
  cancellation: { color: "#EF4444", icon: <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><circle cx="7" cy="7" r="5" stroke="#EF4444" strokeWidth="1.3" /><path d="M5 5l4 4M9 5l-4 4" stroke="#EF4444" strokeWidth="1.3" strokeLinecap="round" /></svg> },
  payment: { color: "#22C55E", icon: <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><rect x="1.5" y="3" width="11" height="8" rx="1.5" stroke="#22C55E" strokeWidth="1.3" /><path d="M1.5 6.5h11" stroke="#22C55E" strokeWidth="1.3" /></svg> },
  reminder: { color: "#9CA3AF", icon: <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M7 1.5a4 4 0 00-4 4v2.5l-1 2h10l-1-2V5.5a4 4 0 00-4-4z" stroke="#9CA3AF" strokeWidth="1.3" /><path d="M5.5 11a1.5 1.5 0 003 0" stroke="#9CA3AF" strokeWidth="1.3" strokeLinecap="round" /></svg> },
  default: { color: "#C9A84C", icon: <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M8 1l1.5 4.5L14 7l-4.5 1.5L8 13l-1.5-4.5L2 7l4.5-1.5L8 1z" fill="#C9A84C" /></svg> },
};
